...
;; (setq doom-font (font-spec :family "noto sans mono" :size 32 :weight 'Regular))
(setq doom-font (font-spec :family "Input mono" :size 40 :weight 'Regular))
(setq doom-variable-pitch-font (font-spec :family "noto sans mono" :size 40))
...
;; [[https://github.com/purcell/exec-path-from-shell][GitHub - purcell/exec-path-from-shell: Make Emacs use the $PATH set up by the...]]
